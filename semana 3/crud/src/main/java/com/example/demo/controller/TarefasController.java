...
public class TarefasController {
	...
	public ResponseEntity<TarefasModel> getByIdTarefa(@PathVariable Long id) {
	...
	public TarefasModel atualizar(@PathVariable Long id, @RequestBody TarefasModel tarefa) {
		tarefa.setId(id);
